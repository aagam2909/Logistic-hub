        ...
        <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white w-full max-w-3xl rounded-2xl shadow-2xl overflow-hidden flex flex-col">
            ...
            <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-4 h-96 overflow-y-auto">
                ...
                <div className="space-y-1"><label className="text-xs font-semibold text-gray-600">E-Way Bill</label><input className="w-full border p-2.5 rounded-lg text-sm" value={editModal.tripData.eway_bill || ''} onChange={e => setEditModal({isOpen: true, tripData: {...editModal.tripData, eway_bill: e.target.value}})} /></div>
